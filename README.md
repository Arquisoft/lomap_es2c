...
[![Actions Status](https://github.com/arquisoft/lomap_es2c/workflows/CI%20for%20LOMAP_ES"C/badge.svg)](https://github.com/arquisoft/lomap_es2c/actions)
[![Quality Gate Status](https://sonarcloud.io/api/project_badges/measure?project=Arquisoft_lomap_es2c&metric=alert_status)](https://sonarcloud.io/summary/new_code?id=Arquisoft_lomap_0)
...
If you want to execute the project you will need [git](https://git-scm.com/downloads), [Node.js and npm](https://www.npmjs.com/get-npm) and [Docker](https://docs.docker.com/get-docker/). Make sure the three of them are installed in your system. Download the project with `git clone https://github.com/arquisoft/lomap_es2c`. The fastest way to launch everything is with docker:
```bash
...
- Documentation: https://github.com/arquisoft/lomap_es2c/tree/master/docs
- Webapp: https://github.com/arquisoft/lomap_es2c/tree/master/webapp
- Restapi: https://github.com/arquisoft/lomap_es2c/tree/master/restapi
...
deploy:
    ...
    - name: Deploy over SSH
      ...
      with:
        ...
        command: |
          wget https://raw.githubusercontent.com/arquisoft/lomap_es2c/master/docker-compose-deploy.yml -O docker-compose.yml
          docker-compose stop
          docker-compose rm -f
          docker-compose pull   
          docker-compose up -d
